        ...
        <>
            ...
            >
                ...
                <Flex
                    ...
                    w={'100vw'}
                >
                        <Text as={"b"} p={'10px'} mt={'15px'} w={'100%'} color={'#272343'} align='center' fontSize={fs2}>Гражданское дело о признании недействительным договора купли-продажи квартиры</Text>
                </Flex>
                <Flex
                    justify={'center'}
                    w={'100vw'}
