        ...
        <>
            ...
            >
                ...
                <Flex
                    ...
                    w={'100vw'}
                >
                        <Text as={"b"} p={'10px'} mt={'15px'} w={'100%'} color={'#272343'} align='center' fontSize={fs2}>Гражданское дело о взыскании действительной стоимости доли в пользу вышедшего участника общества с ограниченной ответственностью.</Text>
                </Flex>
                <Flex
                    justify={'center'}
                    w={'100vw'}
                ...
                <Flex
                    ...
                    w={'100vw'}
                >
                        <Text as={"b"} p={'10px'} mt={'15px'} w={'100%'} color={'#272343'} align='center' fontSize={fs2}>Гражданское дело об определении порядка пользования жилыми помещениями.</Text>
                </Flex>
                <Flex
                    justify={'center'}
                    w={'100vw'}
                ...
                <Flex
                    ...
                    w={'100vw'}
                >
                        <Text as={"b"} p={'10px'} mt={'15px'} w={'100%'} color={'#272343'} align='center' fontSize={fs2}>Дело о взыскании неустойки за просрочку исполнения обязательств по договору подряда.
                        </Text>
                </Flex>
                <Flex
                    justify={'center'}
                ...
                <Flex
                    ...
                    w={'100vw'}
                >
                        <Text as={"b"} p={'10px'} mt={'15px'} w={'100%'} color={'#272343'} align='center' fontSize={fs2}>Дело о понуждении заключения договора на приема жидких бытовых отходов.
                        </Text>
                </Flex>
                <Flex
                    justify={'center'}
                ...
                <Flex
                    ...
                    w={'100vw'}
                >
                        <Text as={"b"} p={'10px'} mt={'15px'} w={'100%'} color={'#272343'} align='center' fontSize={fs2}>Дело об оспаривании постановления Федеральной службы по регулированию алкогольного рынка по Центральному округу привлечения к административной ответственности
                        </Text>
                </Flex>
                <Flex
                    justify={'center'}
                ...
                <Flex
                    ...
                    w={'100vw'}
                >
                        <Text as={"b"} p={'10px'} mt={'15px'} w={'100%'} color={'#272343'} align='center' fontSize={fs2}>Дело о выдаче дубликата исполнительного листа
                        </Text>
                </Flex>
                <Flex
                    justify={'center'}
